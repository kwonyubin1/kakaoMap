						...
						<div class="col-md-9 welcome">
							...
							<div class="row welcome-desc">
								<p class="col-sm-2 col-md-6">
									<a href="http://localhost:8080/loginView"
										class="btn btn-primary w-100">로그인</a>
								</p>
								<p class="col-sm-2 col-md-6">
									<a href="http://localhost:8080/registView"
            ...
            <div class="card">
              ...
              <div class="card-body">
				...
				<div id="slick-slide" class="slick-slider">
					<div class="services-col mx-2 my-3">
						<div class="card">
							<a href="#"> <img src="/resources/assets/images/음식1.jpg"
								alt="" class="card-img-top">
							</a>
							<div class="card-body">
								<h4 class="card-title">히쓰마부시 (장어덮밥)</h4>
								<p class="card-text fw-light mb-4">나고야의 명물 음식으로 꼽히는 장어덮밥인
									히쓰마부시는 달콤한 소스로 양념한 장어를 숯불에 구워 밥 위에 올린 덮밥입니다. 히쓰마부시를 보기만 해도 힘이
									생기는 것 같습니다.</p>
					...
					<div class="services-col mx-2 my-3">
						<div class="card">
							<a href="http://localhost:8080/freeView?boNo=2004"> <img
								src="/resources/assets/images/음식2.jpg" alt=""
								class="card-img-top">
							</a>
							<div class="card-body">
								<h4 class="card-title">왕관식당</h4>
								<p class="card-text fw-light mb-4">대전 동구 중동에 위치한 '왕관식당'입니다.
									하루에 두 시간만 운영되는 곳으로 매스컴에도 여러 번 소개되어 대전뿐만 아니라 전국에서도 유명한 곳입니다.
									콩나물이 섞인 밥에 국내산 한우 암소로 만든 육회를 취향에 맞게 비벼 먹거나 따로 먹으면 됩니다.</p>
								<a
									href="http://localhost:8080/freeView?boNo=2060"
					...
					<div class="services-col mx-2 my-3">
						<div class="card">
							<a href="#"> <img src="/resources/assets/images/음식3.png"
								alt="" class="card-img-top">
							</a>
							<div class="card-body">
								<h4 class="card-title">부여순대</h4>
								<p class="card-text fw-light mb-4">깔끔하면서도 진한 국물의 순대국밥
									전문점입니다. 간과 소면이 따로 나오는 것이 특징입니다. 잡내가 전혀 없어 남녀노소 누구나 즐길 수 있습니다.
									SBS 생방송투데이에 출연하기도 했던 유명 맛집입니다</p>
								<a href="" class="btn btn-primary">바로가기</a>
							</div>
						</div>
					</div>
					...
					<div class="services-col mx-2 my-3">
						<div class="card">
							<a href="#"> <img src="/resources/assets/images/음식4.jpg"
								alt="" class="card-img-top">
							</a>
							<div class="card-body">
								<h4 class="card-title">이태리국시</h4>
								<p class="card-text fw-light mb-4">우송대 외식조리학부 졸업생들이 만든 곳으로
									새롭고 창의적인 음식을 만들어 내는 공간입니다.</p>
								<a href="#" class="btn btn-primary">바로가기</a>
							</div>
						</div>
					</div>
					...
					<div class="services-col mx-2 my-3">
						<div class="card">
							<a href="#"> <img src="/resources/assets/images/음식5.png"
								alt="" class="card-img-top">
							</a>
							<div class="card-body">
								<h4 class="card-title">벽제갈비 방이본점</h4>
								<p class="card-text fw-light mb-4">월스트리트지가 아시아 5대 음식점의 하나로
									선정했고, 중국에서 브랜드 로열티를 받는 등 해외에도 잘 알려진 벽제갈비의 방이동 본점입니다. 1++ 축산 등급
									확인서를 확인할 수 있을 만큼 최고급 한우만을 취급합니다.</p>
								<a href="#" class="btn btn-primary">바로가기</a>
							</div>
						</div>
					</div>
...
function addMarker(position, idx, info) {
    var imageSrc = 'https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
     ...
     var content = '<div class="wrap" onclick="closeOverlay(this)">' + 
            ...
            '                <div><a href="https://map.naver.com/p/search/%EA%B2%94%EB%9F%AC%EB%A6%AC%EC%95%84/place/11583103?c=13.86,0,0,0,dh&placePath=%3Fentry%253Dbmp" target="_blank" class="link">홈페이지</a></div>' + 
            '            </div>' + 
            '        </div>' + 
            '    </div>' +    
            '</div>';
